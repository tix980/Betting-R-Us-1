...
<html lang="en">
    ...
    <table class="table table-bordered tbl">
            ...
            <?php foreach ($blogs as $blog) { ?>
                <tr>
                    ...
                    <td><?= $blog['title']; ?></td>
                    <td><?= $blog['date']; ?></td>
                    <td><?= $blog['author_fname']; ?></td>
                    <td><?= $blog['author_lname']; ?></td>
                    <td><?= $blog['post']; ?></td>
                    <td>
    ...
    <a href="../blogs.php" class="btn btn-secondary btn-lg float-left">Back to main</a>
    <a href="./add_blog.php" id="btn_addBlog" class="btn btn-success btn-lg float-right">Add Blog</a>